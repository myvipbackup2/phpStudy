...
<div id="OSC_Screen"><!-- #BeginLibraryItem "/Library/OSC_Banner.lbi" -->
    <div id="OSC_Banner">
        <div id="OSC_Slogon"><?php echo $_SESSION['name']; ?>'s Blog</div>
        <div id="OSC_Channels">
            <ul>
    ...
    <div id="OSC_Topbar">
        <div id="VisitorInfo">
            当前访客身份：
            <?php echo $_SESSION['name']; ?> [ <a href="<?php echo site_url('blog/unlogin') ?>">退出</a> ]
            ...
            <ul>
                ...
                <li class="Blog" id="blog_24026">
                    ...
                    <div class="outline">
                        ...
                        <span class="blog_admin">( <a href="newBlog.htm">修改</a> | <a
                                    href="javascript:delete_blog(24026)">删除</a> )</span>
                    </div>
                ...
                <li class="Blog" id="blog_24025">
                    ...
                    <div class="outline">
                        ...
                        <span class="blog_admin">( <a href="newBlog.htm">修改</a> | <a
                                    href="javascript:delete_blog(24025)">删除</a> )</span>
                    </div>
