...
<div id="OSC_Screen">
    <div id="OSC_Content" class="CenterDiv">
        ...
        <div class="MainForm" id="reg_page">
            <form id="frm_reg" action="<?php echo site_url('user/do_reg') ?>" method="POST" style="float:left; width:620px;">
                <h2>申请<span style="color: #006600;"> MY Blog</span> 账号，已经申请的请点击<a href="<?php echo site_url('user/login') ?>">这里</a>登录</h2>
    ...
    <div id="OSC_Footer">© myblog LZX</div>
</div>
</body>
</html>